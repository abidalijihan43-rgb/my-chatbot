<!-- Chat Widget UI -->
<button id="chat-widget-button" style="position: fixed; bottom: 20px; right: 20px; width: 60px; height: 60px; border-radius: 50%; background: #854fff; color: white; border: none; font-size: 24px; cursor: pointer; z-index: 9999; box-shadow: 0 4px 10px rgba(0,0,0,0.15);">💬</button>

<div id="chat-widget-container" style="display: none; flex-direction: column; position: fixed; bottom: 90px; right: 20px; width: 350px; height: 450px; background: white; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.2); z-index: 9999; overflow: hidden; font-family: Arial, sans-serif;">
    <div id="chat-widget-header" style="background: #854fff; color: white; padding: 15px; display: flex; justify-content: space-between; align-items: center; font-weight: bold;">
        ...
        <button onclick="closeChatWidget()" style="background: none; border: none; color: white; font-size: 16px; cursor: pointer;">✖</button>
    </div>
    <div id="chat-widget-body" style="flex: 1; padding: 15px; overflow-y: auto; background: #f9f9f9;">
...
<script>
    window.ChatWidgetConfig = {
        webhook: {
            url: 'https://n8n.srv1106977.hstgr.cloud/webhook/dfb00eeb-bb7a-4582-91e4-898b1bc50a48/chat',
            route: 'general'
        }
    };
